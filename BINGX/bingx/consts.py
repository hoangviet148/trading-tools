...
FUNDS_TRANSFER = '/v2/auth/spot/deposit'
WITHDRAWAL_COIN = '/v2/auth/transaction/withdraw'
DEPOSIT_HISTORIY = '/v2/u/wallet/depositRecord'
WITHDRAWAL_HISTORIY = '/v2/u/wallet/withdrawRecord'
DEPOSIT_WITHDRAW_HISTORIY = '/v2/auth/transaction'
CURRENCY_INFO = '/account/v1/currencies'
