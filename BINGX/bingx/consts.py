...
# funding
LIST_DEPOSIT_ADDRESS = '/v2/auth/transaction/bindings'
DEPOSIT_ADDRESS = '/v2/auth/transaction/depositAddress'
WITHDRAWAL_INFO = '/0/private/WithdrawInfo'
GET_BALANCES = '/openApi/spot/v1/account/balance'
FUNDS_TRANSFER = '/openApi/api/v3/post/asset/transfer'
WITHDRAWAL_COIN = '/openApi/wallets/v1/capital/withdraw/apply'
DEPOSIT_HISTORIY = '/openApi/api/v3/capital/deposit/hisrec'
WITHDRAWAL_HISTORIY = '/openApi/api/v3/capital/withdraw/history'
CURRENCY_INFO = '/openApi/wallets/v1/capital/config/getall'
...
ORDER_INFO = '/openApi/spot/v1/trade/query'
